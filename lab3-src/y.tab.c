...
{
       0,    44,    44,    48,    49,    52,    56,    60,    63,    66,
      73,    74,    78,    87,    93,    96,    98,   102,   109,   114,
     121,   128,   136,   137,   138,   141,   144
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "TAB", "NOTOKEN", "GREAT",
  "LESS", "NEWLINE", "DGREAT", "DGREATAMP", "GREATAMP", "PIPE", "AMP",
  "$accept", "goal", "commands", "command", "simple_command",
  "command_and_args", "argument_list", "argument", "command_word",
  "pipe_list", "iomodifier_opt", "io_modifier_list", "background_opt", YY_NULLPTR
};
#endif
...
{
      13,    -6,    -7,    -7,     4,     0,    -7,    -7,    -7,    -7,
      29,    -7,    -7,    -7,     2,    12,    14,    15,    26,    30,
      34,    -7,    21,    -7,    -7,    -7,    -7,    -7,    -7,    -7,
      -7,    -7,    -7,    35,    -7
};
...
{
      -2,     1,    11,     2,    12,    23,   -14,   -14,     3,   -14,
     -14,   -14,   -14,   -14,     1,    25,     2,    26,    27,   -14,
     -14,     3,   -14,   -14,   -14,   -14,   -14,    15,    16,    28,
      17,    18,    19,    29,    31,    15,    16,     2,    17,    18,
      19,    20,    13,    34,    30,    32
};
...
{
       0,     1,     8,     3,     0,     3,     6,     7,     8,     9,
      10,    11,    12,    13,     1,     3,     3,     3,     3,     6,
       7,     8,     9,    10,    11,    12,    13,     6,     7,     3,
       9,    10,    11,     3,    13,     6,     7,     3,     9,    10,
      11,    12,     5,     8,    20,    22
};
...
{
       0,     1,     3,     8,    15,    16,    17,    18,    19,    22,
      23,     8,     0,    17,    20,     6,     7,     9,    10,    11,
      12,    24,    25,     3,    21,     3,     3,     3,     3,     3,
      19,    13,    24,    26,     8
};
...
#line 78 "shell.y" /* yacc.c:1646  */
	...
	vector<string> args = putSubshell((yyvsp[0].string_val));	
